 ...
 * Test for RegisterPostTest class
 */
class RegisterPostTest extends TestCase
{

    /** @var RegisterPost object */
    private $object;
    ...
    public function testExecute()
    {
        ...
        $this->authy->expects($this->atLeastOnce())->method('requestEnroll')->willReturn(['seconds_to_expire'=>60]);
    ...
    public function testExecuteLocalizedException()
    {
        ...
        $this->authy->expects($this->never())->method('requestEnroll');
